...
import { X, Tag, Plus, Flame, Sparkles, Loader2, Store as StoreIcon } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 overflow-y-auto space-y-4 flex-1">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full bg-slate-950/80 border border-slate-700/80 rounded-2xl pl-8 pr-4 py-3 text-base font-bold text-slate-100 placeholder-slate-500 focus:outline-none focus:border-emerald-500"
              />
            </div>
          </div>
          ...
          <div className="p-4 bg-slate-950/60 rounded-2xl border border-slate-800 space-y-3">
            <label className="flex items-center gap-3 cursor-pointer select-none">
              <input
                ...
                className="w-5 h-5 rounded-lg text-rose-500 bg-slate-900 border-slate-700 focus:ring-rose-500 accent-rose-500 cursor-pointer"
              />
              <div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="0.00"
                      className="w-full bg-slate-900 border border-rose-500/40 rounded-xl pl-7 pr-3 py-2 text-sm font-bold text-rose-300 focus:outline-none focus:border-rose-400"
                    />
                  </div>
                </div>
          ...
          <div className="p-3 bg-slate-950/40 rounded-2xl border border-slate-800">
            <label className="flex items-center gap-3 cursor-pointer select-none">
              <input
                ...
                className="w-5 h-5 rounded-lg text-emerald-500 bg-slate-900 border-slate-700 focus:ring-emerald-500 accent-emerald-500 cursor-pointer"
              />
              <div>
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full bg-slate-950/80 border border-slate-700/80 rounded-2xl px-4 py-2.5 text-xs text-slate-100 placeholder-slate-500 focus:outline-none focus:border-emerald-500"
            />
          </div>
          ...
          <PhotoUploader
            ...
            initialUrl={evidencePhotoUrl}
            onPhotoUploaded={(url) => setEvidencePhotoUrl(url)}
            folder="evidence"
            helperText="Toma foto del precio en el anaquel para respaldar el hallazgo"
          />
