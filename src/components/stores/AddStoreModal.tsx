      ...
      <div className="relative w-full max-w-lg bg-slate-900 border border-slate-700/80 rounded-3xl shadow-2xl overflow-hidden my-auto max-h-[92vh] flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 overflow-y-auto space-y-4 flex-1">
          ...
          <div className="space-y-1">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className={`py-3 px-4 rounded-2xl border flex items-center justify-center gap-2 text-xs font-bold transition-all ${
                  type === 'physical'
          ...
          <PhotoUploader
            ...
            initialUrl={logoUrl}
            onPhotoUploaded={(url) => setLogoUrl(url)}
            folder="stores"
            helperText="Foto del logo o frente del local"
          />
